...
public class BankServiceImpl implements BankService {
    ...
    public void createAccount(Connection connection, Account account){
        ...
        if(result < 1) {
            throw new RuntimeException("save account fail");
        }
    }
    ...
    public boolean isExistAccount(Connection connection, long accountNumber){
        ...
        int cnt = accountRepository.countByAccountNumber(connection,accountNumber);
        return cnt > 0;
    }
    ...
    public void dropAccount(Connection connection, long accountNumber) {
        ...
        if(result < 1) {
            throw new RuntimeException("fail -> deleteAccount : " + accountNumber );
        }
    }
